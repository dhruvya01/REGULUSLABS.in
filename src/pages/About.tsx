    ...
    <div className="pt-32 px-6 max-w-7xl mx-auto min-h-screen pb-20 overflow-hidden relative">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-24 relative z-10 text-left">
          ...
          <h1 className="text-4xl md:text-6xl font-black mb-8 text-on-surface tracking-tighter leading-tight max-w-4xl">
            Regulus Labs: <br />
          ...
          <div className="space-y-6 max-w-4xl">
            ...
            <p className="text-on-surface-variant text-lg leading-relaxed font-light border-l-2 border-primary/30 pl-6 italic">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-32">
          <motion.div variants={itemVariants} className="glass-panel p-10 rounded-sm border-l-4 border-primary bg-surface-container/20 shadow-[0_0_20px_rgba(0,209,255,0.1)]">
            <h2 className="text-2xl font-black mb-6 flex items-center gap-3 tracking-tight text-on-surface">
          ...
          <motion.div variants={itemVariants} className="glass-panel p-10 rounded-sm bg-surface-container/20">
            <h2 className="text-2xl font-black mb-6 flex items-center gap-3 tracking-tight text-on-surface">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-on-surface font-bold">Seema Malhotra</p>
                  <p className="text-[10px] text-on-surface-variant/60">Legal & Financial Oversight</p>
                </div>
                <div>
                  <p className="text-xs uppercase tracking-widest text-secondary mb-1">Engineering</p>
                  <p className="text-on-surface font-bold">Dhruvya Malhotra</p>
                  <p className="text-[10px] text-on-surface-variant/60">Technical Vision & Product Engineering</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div 
          className="glass-panel border-primary/20 rounded-sm p-8 md:p-20 text-center relative overflow-hidden bg-surface-container/10 backdrop-blur-3xl neon-glow-primary"
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tighter text-on-surface">
